...
* The original package name 'com.project .job-application-tracker-backend' is invalid and this project uses 'com.project.job_application_tracker_backend' instead.
